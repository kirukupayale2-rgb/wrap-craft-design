            ...
            <Reveal key={title} delay={i * 60}>
              ...
              >
                <img
                  ...
                  width={700}
                  height={512}
                  className="absolute inset-0 h-full w-full object-cover brightness-90 transition-[filter] duration-500 group-hover:brightness-125"
                />
                <span className="absolute inset-0 bg-ink/55 transition-opacity duration-500 group-hover:opacity-25" />
                <span className="relative flex h-full flex-col justify-between p-4">
                  ...
                  <span className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-2">
                    <span className="truncate text-[12.5px] font-semibold text-cream drop-shadow">
                      {title}
                    </span>
